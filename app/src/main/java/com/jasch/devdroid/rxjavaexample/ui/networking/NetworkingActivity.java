package com.jasch.devdroid.rxjavaexample.ui.networking;
...
import com.jasch.devdroid.rxjavaexample.model.UserDetail;
import com.jasch.devdroid.rxjavaexample.utils.Utils;
...
public class NetworkingActivity extends AppCompatActivity {
    ...
    /**
     * This is for football freaks
     */

    private Observable<List<User>> getFootballFansObservable(){
        return Rx2AndroidNetworking.get("https://fierce-cove-29863.herokuapp.com/getAllFootballtFans")
                .build()
                .getObjectListObservable(User.class);
    }
    ...
    */
    ...
    private void findUserWhoLovesBoth(){
        //here we use zip operator to combine both requests

        Observable.zip(getCricketFansObservable(), getFootballFansObservable(),
                new BiFunction<List<User>, List<User>, List<User>>() {
                    @Override
                    public List<User> apply(List<User> users, List<User> users2) throws Exception {
                        List<User> userWhoLovesBoth=filterUserWhoLovesBoth(users,users2);
    ...
    public void zip(View view){
        findUserWhoLovesBoth();
    }
    /**
     * flatmap and filter Operators examples
     */
